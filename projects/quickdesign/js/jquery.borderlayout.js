 ...
 *
 * $Date: 2008-11-09 21:27:07 +0100 (dom, 09 nov 2008) $
 * $Rev: 159 $
 * 
 * NOTE: For best code readability, view this with a fixed-space font and tabs equal to 4-chars
 */
$.fn.borderLayout = function (opts) {
 ...
 */
	...
	,	zIndex: { // set z-index values here
		...
		,	sliding:		1000	// applied to both the pane and its resizer when a pane is 'slid open'
 ...
 */
	 ...
	 * transformData
	 *
	 * Processes the options passed in and transforms them into the format used by borderLayout
 ...
 */
	 ...
	 * create
	 *
	 * Initialize the borderLayout - called automatically whenever an instance of borderLayout is created
	 *
	 * callers  NEVER explicity called - runs automatically when an instance of borderLayout is created.
	 */
	var create = function () {
	...
	var initOptions = function () {
		...
		// remove default options that should be set 'per-pane'
		$.each("paneSelector,resizerCursor".split(","),
		...
		$.each("paneClass,contentSelector,contentIgnoreSelector,applyDefaultStyles".split(","),
 ...
 */
	...
	function allowOverflow (elem) {
		...
		if (typeof elem=="string")
			...
			$P= $(elem).parents(".ui-layout-pane:first");
	...
	*
	* @callers  open(), close()
	* @params  pane   These are the params returned to callbacks by borderLayout
 ...
 */
	...
	,	size:			sizePane		// method - pass a 'pane' AND a 'size' in pixels
