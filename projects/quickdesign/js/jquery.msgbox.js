	...
	$.extend({
		MsgBoxObject: {
			...
			create: function () {
				...
				this.esqueleto.form = $('<div action="' + this.options.formaction + '" method="post"></form>');
            ...
            console.log('subimt form');
					$('input[type=button]:first, button[type=button]:first, button:first', this.esqueleto.form).trigger('click');
